...
app.config['MYSQL_DATABASE_USER'] = ${{ secrets.MySQLDBuser }}
app.config['MYSQL_DATABASE_PASSWORD'] = ${{ secrets.MySQLDBpassword }}
app.config['MYSQL_DATABASE_DB'] = ${{ secrets.MySQLDBname }}
app.config['MYSQL_DATABASE_PORT'] = ${{ secrets.MySQLDBport }}
